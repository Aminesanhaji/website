    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Application Nuxt pour tester ThreeJs
        </h2>
        <p class="mt-3 text-gray-600">
          1- Premier effet de la liste, un élément en background qui change de
          form/sens en scrollant :
          <a href="/scroll" class="button--doc text-green-500 hover:underline"
            >Right here</a
          >, Prochaine étape, remplacer le cube par un élément custom.<br />
        </p>
        <p class="mt-3 text-gray-600">
          2- Deuxième test, des formes géometrique qui change en background,
          <a
            href="/formesgeom"
            class="button--doc text-green-500 hover:underline"
            >Right here</a
          >, Pour le moment on peux choisir différents formes disponible, et
          prochaine étape custom les formes.<br />
        </p>
        <p class="mt-3 text-gray-600">
          3- Ensuite, des élements en background qui suivents le mouvement de la
          souris,
          <a
            href="/bganimation"
            class="button--doc text-green-500 hover:underline"
            >Right here </a
          >, Prochaine étape ça sera de changer les cube par des éléments 3d
          pour un effet comme ici :<br />
          <a
            href="https://s.muz.li/N2ZlYmI0N2My"
            target="_blank"
            class="button--doc text-green-500 hover:underline"
            >Exemple</a
          >
        ...
        <p class="mt-3 text-gray-600">
          4- Un cube avec des videos youtube
          <a
            href="/youtubecube"
            class="button--doc text-green-500 hover:underline"
            >Right here</a
        ...
        <p class="mt-3 text-gray-600">
          5- Afficher un model 3D avec un skin custom et des effets custom aussi
          <a href="/3D" class="button--doc text-green-500 hover:underline"
            >Right here</a
          >, Pour avoir un rendu comme celui la :
          <a
            href="https://s.muz.li/N2ZlYmI0N2My"
            target="_blank"
            class="button--doc text-green-500 hover:underline"
        ...
        <p class="mt-3 text-gray-600">
          7- une map interactif avec la possibilité de se balader
          <a href="/map" class="button--doc text-green-500 hover:underline"
            >Right here</a
          >, A voir ..<br />
        </p>
